...
if(isset($_GET['id'])) {
    ...
    $queryMb = "DELETE FROM mobil WHERE id_mobil = $id";
    hapus($queryMb);
}
                            ...
                            <td>
                                <a href="#">
                                    <button type="button" class="btn btn-primary"
                                        onclick="document.location='/webJualBeli_Mobil/admin/tambah.php?kategori=mobil'">
                                        ...
                                        <td>
                                            <a href="#">
                                                <button class="btn btn-warning" type="button"
                                                    onclick="document.location='/webJualBeli_Mobil/admin/edit.php?edit=<?= $row['id_mobil']; ?>&Kedit=mobil'">
                                                    Edit
                                                </button>
                                            </a>
                                            <a href="?id=<?= $row["id_mobil"]; ?>"
