        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php } else if($_GET['kategori'] === "mobil") {?>
                    <!-- fungsi tambah mobil -->
                        ...
                        <div class="modal-body">
                            <table class="table table-striped bordered">
                                <tr>
                                    <td>Nama Mobil</td>
                                    <td>
                                        <input type="text" placeholder="Nama Mobil" required class="form-control"
                                            name="nama_mobil">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Merek Mobil</td>
                                    <td>
                                        <input type="text" placeholder="Merk Mobil" required class="form-control"
                                            name="merek_mobil">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Harga Mobil</td>
                                    <td>
                                        <input type="number" placeholder="Harga Mobil" required class="form-control"
                                            name="harga_mobil">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="Kategori Mobil" required class="form-control"
                                            name="kategori_mobil">
                                    </td>
                                </tr>
                            </table>
